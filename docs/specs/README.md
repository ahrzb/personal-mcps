...
| 13 | [Web surface](web-and-oauth/13-web-surface.md) | Server-rendered login/device, seven-pane Settings including Execution, approvals and OAuth consent; the SPA's three route families — app/agent catalog and alias views plus the `/audit` explorer (decision 36) — PWA and Web Push. |
...
| 18 | [Decisions made by default](decisions/18-decision-log.md) | Numbered decisions 1–36 and their supersession history. |
