...
| Harness (seed / fake-upstream / fake-app) | before implementation — building it against the skeletons is itself a design check: if seeding a namespace is awkward, a production seam is wrong | agent |
