...
// still renders — /login, /device, /settings, /approvals, /approvals/<id>, /audit and
// /oauth/consent — and nothing else.
//
...
// once-only backup-code reveal, expired and spent approvals, oversize audit
// bodies — and a long-content fixture wherever text can overflow.
