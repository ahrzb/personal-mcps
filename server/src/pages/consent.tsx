...
const NoAgents: FC = () => (
  <div class="empty">
    ...
    {/* §19.5 (amended 2026-09-03): the Agents page, now that it exists — /apps has no
        agent affordance, so it is never named here. */}
    <div class="empty-text">
      Create one under <a href={paths.agentNew}>Agents</a> before connecting a client — the agent it is
